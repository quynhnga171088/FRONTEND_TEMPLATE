        ...
        <div className="hero-inner">
          <div>
            ...
            <div className="hero-cta">
              <a href="#" className="btn btn-teal btn-lg">Browse Courses →</a>
              <a href="#" className="btn btn-outline btn-lg">View Pricing</a>
            </div>
            ...
            <div className="hero-main-card">
              ...
              <div className="hero-card-body">
                ...
                <div className="hero-card-footer">
                  ...
                  <span className="g-font-size-13" style={{ color: 'var(--text-muted)' }}></span>
                </div>
              </div>
            </div>
